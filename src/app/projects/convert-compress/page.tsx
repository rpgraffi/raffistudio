      ...
      <main className="min-h-screen font-sans relative overflow-x-clip">
        ...
        <ProjectContent>
          ...
          <ProjectSection>
            ...
            <ProjectSectionContent>
              <ProjectText>
                Anyone working in web design, app development, or marketing
                knows the struggle. Some formats are better for the web, others
                compress better, some support transparency, and others are
                simply mandatory requirements. Often, you have multiple assets
                that need adjustment simultaneously. While existing tools can
                handle these tasks, I couldn&apos;t find one that handled{" "}
                <TextMarker>everything in a single pipeline</TextMarker>. I
                found myself using one tool to convert, another to compress, and
                a third to resize. This disrupted my workflow, so I started
                designing Convert &amp; Compress.
              </ProjectText>
            </ProjectSectionContent>
          </ProjectSection>
          ...
          <ProjectSection>
            ...
            <ProjectSectionContent>
              <ProjectText>
                The goal was a <TextMarker>single pipeline</TextMarker>{" "}
                combining all the transformations I previously spread across
                different tools. Users needed a before-and-after comparison to
                find the right balance between file size and quality.
                Additionally, the tool had to run{" "}
                <TextMarker>
          ...
          <ProjectSection>
            ...
            <ProjectSectionContent>
              <ProjectText>
                ...
                validated these assumptions by engaging with communities on
                Reddit and gathering feedback from early testers.
              </ProjectText>
              ...
              <ProjectTextBlock>
                ...
                <ProjectText>
                  ...
                  images, resizing assets for different breakpoints. I mapped
                  out which tools I used for each step and identified the
                  friction points: context switching, inconsistent quality
                  settings, and lack of batch processing.
                </ProjectText>
              </ProjectTextBlock>
              ...
              <ProjectTextBlock>
                ...
                <ProjectText>
                  ...
                  <TextMarker>
                    Does this affect many users? Does it fit the app&apos;s
                    scope? Can it be implemented without adding complexity?
                  </TextMarker>{" "}
          ...
          <ProjectSection>
            ...
            <ProjectSectionContent>
              <ProjectText>
                ...
                <TextMarker>native to macOS</TextMarker>, so I chose{" "}
                <TextureIcon
                ...
                <TextMarker>
                  physics-based animations, trackpad gestures, and haptic
                  feedback
                </TextMarker>
                .
              </ProjectText>
              ...
              <ProjectTextBlock>
                ...
                <ProjectText>
                  ...
                  (quality), flipping, background removal, and metadata
                  stripping.
                </ProjectText>
              </ProjectTextBlock>
              ...
              <ProjectTextBlock>
                ...
                <ProjectText>
                  ...
                  compact, easy-to-understand control. Since cropping and
                  scaling along a specific side are rarely done simultaneously,
                  I used a switch to toggle between these two modes.
                </ProjectText>
              ...
              <ProjectTextBlock>
                ...
                <ProjectText>
                  ...
                  adjusts in increments of five. For precise control, clicking
                  the slider converts it into a text input field.
                </ProjectText>
              </ProjectTextBlock>
              ...
              <ProjectTextBlock>
                ...
                <ProjectText>
                  ...
                  current pipeline settings, showing the estimated export size
                  in pixels and kilobytes. Users can remove individual images or
                  copy the processed versions directly to the clipboard.
                </ProjectText>
              </ProjectTextBlock>
              ...
              <ProjectTextBlock>
                ...
                <ProjectText>
                  A direct comparison view was a priority for me and the users.
                  It helps estimate how much an image can be compressed without
              ...
              <ProjectTextBlock>
                ...
                <ProjectText>
                  ...
                  keyboard shortcuts for changing formats, opening the
                  comparison view, deleting, and saving. Users also requested
                  templates, allowing them to save and reuse specific pipelines.
                </ProjectText>
                <ProjectText>
          ...
          <ProjectSection>
            ...
            <ProjectSectionContent>
              <ProjectText>
                ...
                <TextMarker>over 17 languages</TextMarker>. I released the app
                on October 1, 2025. The process wasn&apos;t entirely smooth; I
          ...
          <ProjectSection>
            ...
            <ProjectSectionContent>
              <ProjectText>
                ...
                how to make the app more useful. I kept a backlog of these
                ideas, considering how to integrate them{" "}
          ...
          <ProjectSection>
            ...
            <ProjectSectionContent>
              <ProjectText>
                Marketing took place almost exclusively on Reddit, with
                additional launches on{" "}
          ...
          <ProjectSection>
            ...
            <ProjectSectionContent>
              <ProjectText>
                ...
                <TextMarker>from start to finish</TextMarker>, including
                feedback, marketing, and support, is a lot of work, but
                enjoyable. I learned that{" "}
                <TextMarker>
